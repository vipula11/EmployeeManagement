        ...
        public async Task<IActionResult> DeleteRole(string id)
        {
            ...
            else
            {
                ...
                catch (DbUpdateException ex)
                {
                    ...
                    ViewBag.ErrorMessage = $"{role.Name} role cannot be deleted as there are users in this users " +
                        $"in this role. If you want to delete this role, please remove the users from the " +
                        $"role and then try";
                    return View("Error");
                }
            }
